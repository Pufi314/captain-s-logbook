...
function App() {
  ...
  return (
    <div className="min-h-screen">
        <header className="bg-white/90 text-gray-800 md:bg-[#1a365d] md:text-white p-4 shadow-lg">
      ...
      <main className="max-w-6xl mx-auto p-4 space-y-6">
        ...
        <div id="voyage-section" className="bg-white/95 md:bg-white/80 p-6 rounded-lg shadow-sm border border-gray-200 md:border-gray-100 space-y-4">
          <div>
        ...
        <div id="place-section" className="bg-white/95 md:bg-white/80 p-6 rounded-lg shadow-sm border border-gray-200 md:border-gray-100 space-y-4">
        ...
        <div id="crew-section" className="bg-white/95 md:bg-white/80 p-6 rounded-lg shadow-sm border border-gray-200 md:border-gray-100 space-y-4">
