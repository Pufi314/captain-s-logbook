...
function App() {
  ...
  return (
    <div className="min-h-screen">
        <header className="bg-white/90 text-gray-800 shadow-md border-b border-gray-200 p-4">
      ...
      <main className="max-w-6xl mx-auto p-4 space-y-6">
        ...
        <div id="voyage-section" className="bg-white/95 p-6 rounded-lg shadow-sm border border-gray-200 space-y-4">
          <div>
        ...
        <div id="place-section" className="bg-white/95 p-6 rounded-lg shadow-sm border border-gray-200 space-y-4">
        ...
        <div id="crew-section" className="bg-white/95 p-6 rounded-lg shadow-sm border border-gray-200 space-y-4">
